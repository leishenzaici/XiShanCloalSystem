...
import com.xs.coal.pojo.Permission;
import com.xs.coal.pojo.User;
...
public interface UserMapper {
    ...
    public String getuseridByUseridcard(String useridcard) throws SQLException;
    /**
     * 根据用户名查询角色
     * @param userid
...
//	public List<EmployeeIn> getEmployeeInWithoutUserByDepartId(@Param("departmentid")String departmentid)throws SQLException;
	 ...
	 * @throws SQLException
	 */
	public int updatePassword(@Param("useridcard") String useridcard, @Param("password") String password, @Param("username") String username, @Param("userphone") String userphone)throws SQLException;
