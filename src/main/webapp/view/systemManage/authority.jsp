...
<body>
	...
	<!--中部-->
	<div class="html_middle" style="float: left;">
		...
		<div style="float: left;">
			...
			<div>
				<div
					...
					<span style="padding: 5px 0 5px 10px; line-height: 42px;">系统管理</span><span>>权限管理</span>
				</div>
				...
				<div class="panel-body el_main">
					...
					<div class="el_leftTree">
						...
						<ul style="font-size: 19px;" id="tree_systemmanage_menu"
							class="ztree"></ul>
					</div>
					...
					<div class="col-md-10 el_qlmContent">
							...
							<form id="form_permissioninfo" action="">
								...
								<div class="col-md-3 el_qlmQuery">
									<div class="input-group" role="toolbar">
										<span class="el_spans">权限名称：</span> <input type="text"
											class="form-control" name="permissionname" />
									</div>
								</div>

								<div class="col-md-3 el_qlmQuery el_qlmQueryR">
									<div class="input-group" role="toolbar">
										<span class="el_spans">权限状态：</span> <label class="el_radioBox"><input
											type="radio" name="permissionstatus" value='1'> 启用</label>&nbsp;
										<label class="el_radioBox"><input type="radio"
											name="permissionstatus" value='0'> 禁用</label>
									</div>
								</div>
								...
								<button type="button"
									...
									onclick='getPermissionByCondition()'>查询</button>
							</form>
						...
						<!-- 模态框 修改用户信息-->
						<div class="modal fade" id="modifyUserInfo" tabindex="-1"
									...
									<form>
										<div class="modal-body">
											...
											<div class="input-group el_modellist" role="toolbar">
												<span class="el_spans">权限名称：</span> <input type="text"
													class="form-control el_modelinput" name="" /> <span></span>
											</div>

											<div class="input-group el_modellist" role="toolbar">
												<span class="el_spans">权限状态：</span> <label
													class="el_radioBox"><input type="radio"
													name="el_state"> 启用</label>&nbsp; <label
													class="el_radioBox"><input type="radio"
													name="el_state"> 禁用</label>
											</div>

											<div class="input-group el_modellist" role="toolbar">
												<span class="el_spans">权限类别：</span> <select
