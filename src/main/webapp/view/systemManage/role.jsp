...
<%--     <!--放菜单框-->
    ...
    <div style="float:left;">
        <!--菜单连接标题-->
        <div>
			<div style="background-color:#f5f5f5;width:100%;height:42px;border-bottom:1px soild #dddddd;">
			<span style="padding:5px 0 5px 10px;line-height:42px;">系统管理</span><span>>角色管理</span>
		</div>
                            ...
                            <form id="form_addroleinfo">
                                <div class="modal-body">
                                    ...
                                    <div class="input-group el_modellist" role="toolbar">
                                        ...
                                        <input type="text" class="form-control el_modelinput" id="form_rolename" name="rolename"/>
                                        <span></span>
                                    </div>

                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">角色状态：</span>
                                        <label class="el_radioBox"><input type="radio" id="rolestatus_use" name="rolestatus" value='1' checked> 启用</label>&nbsp;
                                        <label class="el_radioBox"><input type="radio" name="rolestatus" value='0'> 禁用</label>
                                    </div>
                                    ...
                                    <div class="input-group el_modellist" role="toolbar">
                                        ...
                                        <textarea class="form-control el_modelinput" name='description' id="form_roledescription" rows="1"></textarea>
                                    </div>

                                    <input type="hidden" name='departmentid' id='hidden_departmentid' >
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button><!--关闭符号-->
                                <!--标题-->
                                <h4 class="modal-title" id="myModalLabel242">批量添加角色</h4>
                            </div>
                            <form id="form_addmorerole">
                                <div class="modal-body">
                                    ...
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">角色名称：</span>
                                        <input type="text" class="form-control el_modelinput" name="rolename"/>
                                        <span></span>
                                    </div>

                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">角色状态：</span>
                                        <label class="el_radioBox"><input type="radio" name="rolestatus" checked value='1'> 启用</label>&nbsp;
                                        <label class="el_radioBox"><input type="radio" name="rolestatus" value='0'> 禁用</label>
                                    </div>

                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">角色描述：</span>
                                        <textarea class="form-control el_modelinput" name="description" rows="1"></textarea>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="form_updateroleinfo">
                                <div class="modal-body">
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">角色名称：</span>
                                        <input type="text" class="form-control el_modelinput" id="updateroleinfo_rolename" name="rolename"/>
                                        <span></span>
                                    </div>

                                 <input type="hidden" id="hidden_update_roleid" name="roleid"> 	 

                                    

                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">角色描述：</span>
                                        <textarea class="form-control el_modelinput" id="updateroleinfo_description" name="description" rows="1"></textarea>
                                    </div>
